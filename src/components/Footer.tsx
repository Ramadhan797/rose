      ...
      <div className="relative container mx-auto max-w-4xl text-center">
        ...
        >
          ...
          <p className="text-muted-foreground mb-8 max-w-md mx-auto">
            Spread love, one rose at a time. May your day be filled with the fragrance of affection.
          </p>
          ...
          {/* Valentine's week */}
          <div className="glass rounded-2xl p-6 max-w-md mx-auto mb-10">
            <h4 className="font-serif text-lg text-foreground mb-4">Made by Ramsuy for Nana</h4>
