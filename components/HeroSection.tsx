    ...
    <section className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden bg-gradient-hero">
      ...
      >
        <div className="glass px-6 py-2 rounded-full flex items-center gap-2">
          <span className="text-xs uppercase tracking-widest text-muted-foreground">Valentine's Day Every Day</span>
      ...
      <div className="relative z-10 container mx-auto px-4 flex flex-col lg:flex-row items-center justify-center gap-8 lg:gap-16">
        ...
        >
          ...
          >
            <button 
              className="group relative px-8 py-4 bg-primary text-primary-foreground rounded-full font-medium shadow-rose hover:shadow-glow transition-all duration-300 overflow-hidden"
              data-interactive
            >
            ...
            <button 
              className="px-8 py-4 border-2 border-rose-soft text-rose-deep rounded-full font-medium hover:bg-rose-soft/20 transition-all duration-300"
              data-interactive
            >
              Explore Garden
            </button>
